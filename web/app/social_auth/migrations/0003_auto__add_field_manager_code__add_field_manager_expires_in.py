...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Manager.code'
        db.add_column('social_auth_manager', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Adding field 'Manager.expires_in'
        db.add_column('social_auth_manager', 'expires_in',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Manager.code'
        db.delete_column('social_auth_manager', 'code')

        # Deleting field 'Manager.expires_in'
        db.delete_column('social_auth_manager', 'expires_in')
