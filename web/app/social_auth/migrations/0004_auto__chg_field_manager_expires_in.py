...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Manager.expires_in'
        db.alter_column('social_auth_manager', 'expires_in', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Manager.expires_in'
        db.alter_column('social_auth_manager', 'expires_in', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
