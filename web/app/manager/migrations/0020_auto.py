...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'VkPostEvent', fields ['event_id']
        db.create_index('manager_vkpostevent', ['event_id'])


    def backwards(self, orm):
        # Removing index on 'VkPostEvent', fields ['event_id']
        db.delete_index('manager_vkpostevent', ['event_id'])
    ...
    models = {
        ...
        'manager.vkpostevent': {
            ...
            'event_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'event_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
