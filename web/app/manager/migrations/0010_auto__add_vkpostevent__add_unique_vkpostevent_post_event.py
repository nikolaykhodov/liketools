...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VkPostEvent'
        db.create_table('manager_vkpostevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manager.VkPost'])),
        ...
        db.send_create_signal('manager', ['VkPostEvent'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VkPostEvent'
        db.delete_table('manager_vkpostevent')
    ...
    models = {
        ...
        'manager.vkpostevent': {
            'Meta': {'unique_together': "(('post', 'event'),)", 'object_name': 'VkPostEvent'},
