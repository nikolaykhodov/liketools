...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('manager_campaign', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social_auth.Manager'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('manager', ['Campaign'])

        # Adding unique constraint on 'Campaign', fields ['manager', 'name']
        db.create_unique('manager_campaign', ['manager_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Campaign', fields ['manager', 'name']
        db.delete_unique('manager_campaign', ['manager_id', 'name'])

        # Deleting model 'Campaign'
        db.delete_table('manager_campaign')
