...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VkPost.links'
        db.add_column('main_vkpost', 'links',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


        # Changing field 'VkPost.log'
        db.alter_column('main_vkpost', 'log', self.gf('jsonfield.fields.JSONField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VkPost.links'
        db.delete_column('main_vkpost', 'links')


        # Changing field 'VkPost.log'
        db.alter_column('main_vkpost', 'log', self.gf('django.db.models.fields.TextField')())
