...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VkPost.owner_id'
        db.delete_column('main_vkpost', 'owner_id')

        # Adding field 'VkPost.owner_ids'
        db.add_column('main_vkpost', 'owner_ids',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VkPost.owner_id'
        db.add_column('main_vkpost', 'owner_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'VkPost.owner_ids'
        db.delete_column('main_vkpost', 'owner_ids')
    ...
    models = {
        ...
        'manager.vkpost': {
            ...
            'owner_ids': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024'}),
