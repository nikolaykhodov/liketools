...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Account', fields ['manager', 'name']
        db.create_unique('manager_account', ['manager_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Account', fields ['manager', 'name']
        db.delete_unique('manager_account', ['manager_id', 'name'])
