...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VkPost.editor_data'
        db.add_column('main_vkpost', 'editor_data',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8092),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VkPost.editor_data'
        db.delete_column('main_vkpost', 'editor_data')
