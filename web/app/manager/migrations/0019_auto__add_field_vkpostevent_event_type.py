...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VkPostEvent.event_type'
        db.add_column('manager_vkpostevent', 'event_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VkPostEvent.event_type'
        db.delete_column('manager_vkpostevent', 'event_type')
