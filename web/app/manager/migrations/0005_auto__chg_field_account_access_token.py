...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.access_token'
        db.alter_column('manager_account', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Account.access_token'
        db.alter_column('manager_account', 'access_token', self.gf('django.db.models.fields.CharField')(max_length=128))
