...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VkPost.manager'
        db.delete_column('main_vkpost', 'manager_id')

        # Adding field 'VkPost.campaign'
        db.add_column('main_vkpost', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['manager.Campaign']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VkPost.manager'
        raise RuntimeError("Cannot reverse this migration. 'VkPost.manager' and its values cannot be restored.")
        # Deleting field 'VkPost.campaign'
        db.delete_column('main_vkpost', 'campaign_id')
