...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VkPost.owner_ids'
        db.alter_column('main_vkpost', 'owner_ids', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'VkPost.owner_ids'
        db.alter_column('main_vkpost', 'owner_ids', self.gf('django.db.models.fields.CharField')(max_length=1024))
